...
| **Measured graph accuracy** — precision and recall per node/edge kind, for the **9 of 10 front-ends with a committed corpus** (Perl's lands with `CALLS` in a later phase), against a published hand-labelled corpus. Not "grounded" as an adjective; a number you can check | ✅ | `orchestrator pkg accuracy` |
