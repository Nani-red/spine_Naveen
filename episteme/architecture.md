...
**Graph size:** 14968 nodes · 41861 edges — 7848 functions · 3291 fields · 1637 docs · 1114 modules · 999 types · 72 endpoints · 7 entitys.
...
**1637 docs** ingested, naming **885 of 9316 symbols** (9% doc coverage).

**930 potential drift** — the docs name code the graph doesn't have (renamed or removed symbols, or prose the binder can't resolve).
