...
**Graph size:** 14988 nodes · 41858 edges — 7847 functions · 3291 fields · 1659 docs · 1113 modules · 999 types · 72 endpoints · 7 entitys.
...
|---|---|---|---|---|
| [`orchestrator.pkg`](areas/orchestrator.pkg.md) | orchestrator | 48 | 109 | 418 |
...
**2311 public** symbols · **1567 internal**, of 3878. Most of this codebase is machinery you don't need to read to use it.
...
flowchart LR
  subgraph c_2["sdlc · pkg (10)"]
    ...
    aorchestratorpkg["orchestrator.pkg<br/>109 types · 681 fns"]
...
**1659 docs** ingested, naming **889 of 9314 symbols** (10% doc coverage).
...
- [`_text`](../src/orchestrator/pkg/php_extractor.py#L1051) — 33 production call-sites · **reaches 27 symbols** (≤3 hops)
  - called by [`_base_type_names`](../src/orchestrator/pkg/php_extractor.py#L920), [`_const_names`](../src/orchestrator/pkg/php_extractor.py#L938), [`_field_text`](../src/orchestrator/pkg/php_extractor.py#L1046), [`_interface_names`](../src/orchestrator/pkg/php_extractor.py#L927), [`_is_this_property`](../src/orchestrator/pkg/php_extractor.py#L771), +12 more
