...
**Graph size:** 14990 nodes · 41874 edges — 7848 functions · 3291 fields · 1659 docs · 1114 modules · 999 types · 72 endpoints · 7 entitys.
...
**1659 docs** ingested, naming **890 of 9316 symbols** (10% doc coverage).

**931 potential drift** — the docs name code the graph doesn't have (renamed or removed symbols, or prose the binder can't resolve).
