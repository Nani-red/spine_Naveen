...
**Graph size:** 14980 nodes · 41824 edges — 7839 functions · 3291 fields · 1659 docs · 1113 modules · 999 types · 72 endpoints · 7 entitys.
...
|---|---|---|---|---|
| [`orchestrator.pkg`](areas/orchestrator.pkg.md) | orchestrator | 48 | 109 | 415 |
...
**2311 public** symbols · **1564 internal**, of 3875. Most of this codebase is machinery you don't need to read to use it.

Most-depended-upon public symbols: [`Provenance`](../src/orchestrator/pkg/facts.py#L81), [`Edge`](../src/orchestrator/pkg/facts.py#L137), [`Node`](../src/orchestrator/pkg/facts.py#L121), [`Failure`](../src/orchestrator/plugin/outputs.py#L38), [`LLMCodegenAdapter`](../src/orchestrator/sdlc/codegen.py#L827), [`RepoCodeExtractor`](../src/orchestrator/pkg/extractor.py#L599), [`FactBatch`](../src/orchestrator/pkg/facts.py#L150), [`TargetLayout`](../src/orchestrator/sdlc/layout.py#L79), [`load_local_env`](../src/orchestrator/core/env.py#L20), [`FactStore`](../src/orchestrator/pkg/store.py#L25), [`GroundingVerifier`](../src/orchestrator/pkg/verifier.py#L52), [`RunContext`](../src/orchestrator/sdlc/autorun.py#L65), [`map_repo`](../src/orchestrator/plugin/server.py#L407), [`regression_gaps`](../src/orchestrator/plugin/server.py#L700), [`TestRunResult`](../src/orchestrator/sdlc/testrunner.py#L78), +2296 more
...
- 10 modules: `orchestrator.pkg.c_extractor` ↔ `orchestrator.pkg.cpp_extractor` ↔ `orchestrator.pkg.csharp_extractor` ↔ `orchestrator.pkg.extractor` ↔ `orchestrator.pkg.java_extractor` ↔ `orchestrator.pkg.php_extractor`, +4 more
...
flowchart LR
  subgraph c_2["sdlc · pkg (10)"]
    ...
    aorchestratorpkg["orchestrator.pkg<br/>109 types · 678 fns"]
...
| `tests.pkg` | → | `orchestrator.pkg` | 316 |
...
Size distribution: **861** 1-10 · **70** >10 · **56** marker · **5** >25 · **1** god (>40)
...
**1659 docs** ingested, naming **889 of 9306 symbols** (10% doc coverage).

**926 potential drift** — the docs name code the graph doesn't have (renamed or removed symbols, or prose the binder can't resolve).
...
- [`orchestrator.pkg.php_extractor`](modules/orchestrator.pkg.php_extractor.md) — 3 types, 27 functions
...
- [`orchestrator.pkg.php_routes`](modules/orchestrator.pkg.php_routes.md) — 1 types, 22 functions
...
_Showing the 25 biggest of 347 first-party modules._
...
- [`_text`](../src/orchestrator/pkg/php_extractor.py#L1017) — 32 production call-sites · **reaches 27 symbols** (≤3 hops)
  - called by [`_base_type_names`](../src/orchestrator/pkg/php_extractor.py#L886), [`_const_names`](../src/orchestrator/pkg/php_extractor.py#L904), [`_field_text`](../src/orchestrator/pkg/php_extractor.py#L1012), [`_interface_names`](../src/orchestrator/pkg/php_extractor.py#L893), [`_is_this_property`](../src/orchestrator/pkg/php_extractor.py#L737), +12 more
