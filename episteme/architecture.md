...
**Graph size:** 15037 nodes · 42086 edges — 7900 functions · 3291 fields · 1647 docs · 1119 modules · 1001 types · 72 endpoints · 7 entitys.
...
|---|---|---|---|---|
| [`orchestrator.pkg`](areas/orchestrator.pkg.md) | orchestrator | 49 | 109 | 418 |
...
flowchart LR
  subgraph c_2["sdlc · pkg (10)"]
    ...
    aorchestratorsdlc["orchestrator.sdlc<br/>120 types · 669 fns"]
  end
...
| `tests.pkg` | → | `orchestrator.pkg` | 317 |
...
Size distribution: **863** 1-10 · **70** >10 · **56** marker · **5** >25 · **1** god (>40)
...
**27 of 50 components** are imported by at least one test.
...
**1647 docs** ingested, naming **891 of 9374 symbols** (10% doc coverage).
...
_Showing the 25 biggest of 349 first-party modules._
