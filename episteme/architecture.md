...
**Graph size:** 14979 nodes · 41893 edges — 7857 functions · 3291 fields · 1637 docs · 1116 modules · 999 types · 72 endpoints · 7 entitys.
...
**1637 docs** ingested, naming **888 of 9327 symbols** (10% doc coverage).

**932 potential drift** — the docs name code the graph doesn't have (renamed or removed symbols, or prose the binder can't resolve).
