...
**Graph size:** 15186 nodes · 42674 edges — 7993 functions · 3310 fields · 1671 docs · 1125 modules · 1008 types · 72 endpoints · 7 entitys.
...
**2364 public** symbols · **1584 internal**, of 3948. Most of this codebase is machinery you don't need to read to use it.

Most-depended-upon public symbols: [`Provenance`](../src/orchestrator/pkg/facts.py#L81), [`Edge`](../src/orchestrator/pkg/facts.py#L137), [`Node`](../src/orchestrator/pkg/facts.py#L121), [`Failure`](../src/orchestrator/plugin/outputs.py#L38), [`TargetLayout`](../src/orchestrator/sdlc/layout.py#L80), [`LLMCodegenAdapter`](../src/orchestrator/sdlc/codegen.py#L866), [`RepoCodeExtractor`](../src/orchestrator/pkg/extractor.py#L615), [`FactBatch`](../src/orchestrator/pkg/facts.py#L150), [`load_local_env`](../src/orchestrator/core/env.py#L20), [`FactStore`](../src/orchestrator/pkg/store.py#L25), [`TestRunResult`](../src/orchestrator/sdlc/testrunner.py#L78), [`GroundingVerifier`](../src/orchestrator/pkg/verifier.py#L52), [`RunContext`](../src/orchestrator/sdlc/autorun.py#L65), [`map_repo`](../src/orchestrator/plugin/server.py#L407), [`regression_gaps`](../src/orchestrator/plugin/server.py#L700), +2349 more
...
Size distribution: **867** 1-10 · **71** >10 · **57** marker · **5** >25 · **1** god (>40)
...
**1671 docs** ingested, naming **905 of 9473 symbols** (10% doc coverage).

**954 potential drift** — the docs name code the graph doesn't have (renamed or removed symbols, or prose the binder can't resolve).
...
_Showing the 25 biggest of 351 first-party modules._
