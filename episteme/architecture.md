...
**Graph size:** 15092 nodes · 42302 edges — 7944 functions · 3295 fields · 1648 docs · 1122 modules · 1004 types · 72 endpoints · 7 entitys.
...
|---|---|---|---|---|
| [`orchestrator.pkg`](areas/orchestrator.pkg.md) | orchestrator | 49 | 109 | 419 |
| [`orchestrator.sdlc`](areas/orchestrator.sdlc.md) | orchestrator | 48 | 120 | 370 |
...
**2346 public** symbols · **1578 internal**, of 3924. Most of this codebase is machinery you don't need to read to use it.

Most-depended-upon public symbols: [`Provenance`](../src/orchestrator/pkg/facts.py#L81), [`Edge`](../src/orchestrator/pkg/facts.py#L137), [`Node`](../src/orchestrator/pkg/facts.py#L121), [`Failure`](../src/orchestrator/plugin/outputs.py#L38), [`LLMCodegenAdapter`](../src/orchestrator/sdlc/codegen.py#L827), [`RepoCodeExtractor`](../src/orchestrator/pkg/extractor.py#L615), [`FactBatch`](../src/orchestrator/pkg/facts.py#L150), [`TargetLayout`](../src/orchestrator/sdlc/layout.py#L79), [`load_local_env`](../src/orchestrator/core/env.py#L20), [`FactStore`](../src/orchestrator/pkg/store.py#L25), [`GroundingVerifier`](../src/orchestrator/pkg/verifier.py#L52), [`RunContext`](../src/orchestrator/sdlc/autorun.py#L65), [`map_repo`](../src/orchestrator/plugin/server.py#L407), [`regression_gaps`](../src/orchestrator/plugin/server.py#L700), [`TestRunResult`](../src/orchestrator/sdlc/testrunner.py#L78), +2331 more
...
- 8 modules: `orchestrator.pkg.c_extractor` ↔ `orchestrator.pkg.cpp_extractor` ↔ `orchestrator.pkg.csharp_extractor` ↔ `orchestrator.pkg.extractor` ↔ `orchestrator.pkg.java_extractor` ↔ `orchestrator.pkg.php_extractor`, +2 more
...
flowchart LR
  subgraph c_2["sdlc · pkg (10)"]
    ...
    aorchestratorpkg["orchestrator.pkg<br/>109 types · 682 fns"]
    aorchestratorplugin["orchestrator.plugin<br/>69 types · 133 fns"]
    aorchestratorsdlc["orchestrator.sdlc<br/>120 types · 670 fns"]
  end
...
| `tests.pkg` | → | `orchestrator.pkg` | 323 |
...
Size distribution: **864** 1-10 · **70** >10 · **57** marker · **5** >25 · **1** god (>40)
...
**27 of 51 components** are imported by at least one test.

Largest components no test imports: `scripts.render_knowledge_foundation_svg` (2 types), `scripts.sdlc_shapes` (2 types), `scripts.codegen_benchmark` (1 type), `scripts.render_architecture_svg` (1 type), `scripts.state-numbers` (1 type).
...
**1648 docs** ingested, naming **894 of 9422 symbols** (9% doc coverage).

**941 potential drift** — the docs name code the graph doesn't have (renamed or removed symbols, or prose the binder can't resolve).

| The docs claim… | …in |
|---|---|
| `CliRunner` | CHANGELOG.md |
...
_Showing the 25 biggest of 350 first-party modules._
...
- [`_write`](../scripts/sdlc_shapes.py#L93) — 17 production call-sites · **reaches 5 symbols** (≤1 hop)
  - called by [`_spec`](../scripts/sdlc_shapes.py#L98), [`build_monorepo`](../scripts/sdlc_shapes.py#L144), [`build_multirepo`](../scripts/sdlc_shapes.py#L166), [`build_single`](../scripts/sdlc_shapes.py#L127), [`build_submodule`](../scripts/sdlc_shapes.py#L196)
