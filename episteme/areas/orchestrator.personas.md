...
**`orchestrator.personas`** is one of 55 areas in this repo, in the `orchestrator` zone. It holds 5 modules — 5 types and 10 functions. It sits in the middle of the graph: 5 areas below it, 5 above. Changes here can reach both ways.
