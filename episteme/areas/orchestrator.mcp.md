...
**`orchestrator.mcp`** is one of 55 areas in this repo, in the `orchestrator` zone. It holds 10 modules — 11 types and 25 functions. It sits in the middle of the graph: 3 areas below it, 5 above. Changes here can reach both ways.
