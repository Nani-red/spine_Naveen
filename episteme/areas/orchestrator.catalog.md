...
**`orchestrator.catalog`** is one of 55 areas in this repo, in the `orchestrator` zone. It holds 8 modules — 13 types and 25 functions. It sits in the middle of the graph: 1 area below it, 7 above. Changes here can reach both ways.
