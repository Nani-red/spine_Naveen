...
**`orchestrator.pkg`** is one of 53 areas in this repo, in the `orchestrator` zone. It holds 48 modules — 109 types and 415 functions. It sits in the middle of the graph: 1 area below it, 16 above. Changes here can reach both ways.
