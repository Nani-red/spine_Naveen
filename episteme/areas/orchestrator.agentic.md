...
**`orchestrator.agentic`** is one of 55 areas in this repo, in the `orchestrator` zone. It holds 8 modules — 13 types and 16 functions. It sits in the middle of the graph: 5 areas below it, 3 above. Changes here can reach both ways.
