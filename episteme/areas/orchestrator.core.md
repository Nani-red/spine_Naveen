...
**`orchestrator.core`** is one of 55 areas in this repo, in the `orchestrator` zone. It holds 16 modules — 33 types and 31 functions. It sits in the middle of the graph: 1 area below it, 25 above. Changes here can reach both ways.
