...
**`orchestrator.codereview`** is one of 55 areas in this repo, in the `orchestrator` zone. It holds 12 modules — 34 types and 25 functions. It sits in the middle of the graph: 4 areas below it, 4 above. Changes here can reach both ways.
