...
**`orchestrator.spine`** is one of 54 areas in this repo, in the `orchestrator` zone. It holds 14 modules — 33 types and 19 functions. It sits in the middle of the graph: 1 area below it, 3 above. Changes here can reach both ways.
