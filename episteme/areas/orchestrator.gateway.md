...
**`orchestrator.gateway`** is one of 55 areas in this repo, in the `orchestrator` zone. It holds 19 modules — 25 types and 14 functions. It sits in the middle of the graph: 4 areas below it, 1 above. Changes here can reach both ways.
